...
type Flags struct {
	...
	ServeAPIKey                     string               `long:"api-key" env:"FABRIC_SERVER_API_KEY" description:"API key used to secure server routes (can also be set via FABRIC_SERVER_API_KEY env var)" default:""`
