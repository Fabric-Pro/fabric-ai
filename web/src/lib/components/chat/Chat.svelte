...
function handleVerticalResize(e: MouseEvent) {
	...
	const maxHeight = Math.min(
		MAX_INPUT_HEIGHT,
		100 - MIN_SYSTEM_INSTRUCTIONS_HEIGHT,
	); // Max 200% of default or ensure system instructions are visible
	...
	const sysInstructionsPixelHeight =
		(columnHeight * newSysInstructionsHeight) / 100;
